        ...
        <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
            <div class="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4">
                <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
					...
					<form action="<?php echo base_url('Kayit/kaydol') ?>" method="POST">
                    <div class="form-floating mb-3">
						<input type="text" class="form-control" name="kadi" id="floatingPassword" placeholder="Password">
                        <label for="floatingInput">Kullanıcı Adınız</label>
                    </div>
					<div class="form-floating mb-3">
						<input type="text" class="form-control" name="eposta" id="floatingPassword" placeholder="Password">
                        <label for="floatingInput">E-posta adresiniz</label>
                    </div>
                    <div class="form-floating mb-4">
						<input type="password" class="form-control" name="sifre" id="floatingPassword" placeholder="Password">
