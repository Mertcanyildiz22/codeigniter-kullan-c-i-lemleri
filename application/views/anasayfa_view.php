        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-6">
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <form action="<?php echo base_url('Araba_kayit/kaydet') ?>" method="POST">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Araç Markası</label>
                            <input type="text" name="marka" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"> 
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="kullanici" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $this->session->userdata('kadi')?>"> 
                        </div>
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="bg-secondary rounded h-100 p-4">
                    <h6 class="mb-4">Araba Listesi</h6>
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col">#</th>
                        ...
                        <tbody>
                            <?php
                             if ($veri) { 
                                $i= 1;
                             foreach ($veri as $araba ){?>
                            <tr>
                                <td><?php echo $i;?></td>
                                <td><?php echo $araba['marka'];?></td>
                                <td><td><?php echo $araba['model'];?></td></td>
                                <td><?php echo $araba['kullanici'];?></td>
                                <td><?php echo $araba['kayit_tarihi'];?></td>
                                <td><a href="<?php echo base_url('Araba_kayit/aracduzenle/').$araba['id'];?>"><i class="fa fa-edit me-lg-2"></i></a></td>
                                <td><a href="<?php echo base_url('Araba_kayit/sil/').$araba['id'];?>"><i class="fa fa-trash me-lg-2"></i></a></td>
                            </tr>
                            <?php $i++;} }?>
                        </tbody>
                    </table>
