        ...
        <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
            <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
					...
					<form action="<?php echo base_url('Giris/unuttum/').$this->input->post('eposta'); ?>" method="POST">
                    <div class="form-floating mb-3">
						<input type="text" class="form-control" name="eposta" placeholder="E-posta">
                        <label for="floatingInput">E-posta Adresinizi giriniz...</label>
                    </div>
                    <button type="submit" class="btn btn-primary py-3 w-100 mb-4">Şifre Gönder</button>
