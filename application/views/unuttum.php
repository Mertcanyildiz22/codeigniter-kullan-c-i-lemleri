        ...
        <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
            <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
					...
					<form action="<?php echo base_url('Giris/unuttumupdate/'.$id.''); ?>" method="POST">
                    <div class="form-floating mb-4">
					<input type="password" class="form-control" name="yenisifre1" placeholder="Şifre">
                        <label for="floatingPassword">Yeni Şifrenizi Girin</label>
                    </div>
                    <div class="form-floating mb-4">
					<input type="password" class="form-control" name="yenisifre2" placeholder="Şifre">
                        <label for="floatingPassword">Yeni Şifrenizi Tekrar Girin</label>
                    </div>
                    <button type="submit" class="btn btn-primary py-3 w-100 mb-4">Şifreyi Kaydet</button>
					</form>
                </div>
            </div>
        </div>
